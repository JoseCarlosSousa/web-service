...
export default function UserDashboard() {
  ...
  if (loading) {
    return <p className="profile-loading">{t("loading_profile")}...</p>;
  }

  return (
    <div className="user-profile-section">
      <h3 className="profile-title">👤 {t("profile_title")}</h3>
      <p className="profile-subtitle">{t("profile_subtitle")}</p>
      ...
      <form onSubmit={handleSubmit} className="profile-form">
        ...
        <div className="form-row">
          <div className="form-field">
            <label className="form-label">{t("form_first_name")}</label>
            <input
              type="text"
              name="firstName"
        ...
        <div className="form-row">
          ...
          <div className="form-field">
            <label className="form-label">{t("form_phone_number")}</label>
            <input
              type="text"
              name="phoneNumber"
        ...
        <div className="form-row-triple">
          <div className="form-field">
            <label className="form-label">{t("form_city")}</label>
            <input
              type="text"
              name="city"
              value={formData.city}
          ...
          <div className="form-field">
            <label className="form-label">{t("form_state")}</label>
            <input
              type="text"
              name="state"
          ...
          <div className="form-field">
            <label className="form-label">{t("form_zip_code")}</label>
            <input
              type="text"
              name="zipCode"
